...
class ElementCreateView(LoginRequiredMixin, CreateView):
    model = Element
    fields = ['title']
    template_name = "courses/element_form.html"
...
class CriteriaCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        form.instance.element_id = self.kwargs['element_id']
        return super().form_valid(form)

    def get_success_url(self):
        return reverse_lazy('unit_detail', kwargs={'pk': self.object.element.unit.pk})
...
class TaskAssessmentCreateView(LoginRequiredMixin, CreateView):
...
class TaskAssessmentUpdateView(LoginRequiredMixin, UpdateView):
    model = TaskAssessment
    fields = ['title', 'type', 'max_marks']
    template_name = "courses/task_assessment_form.html"
...
class TaskAssessmentDeleteView(LoginRequiredMixin, DeleteView):
    model = TaskAssessment
...
class TaskStandardCreateView(LoginRequiredMixin, CreateView):
    model = TaskStandard
    fields = ['description']
...
class TaskStandardUpdateView(LoginRequiredMixin, UpdateView):
    model = TaskStandard
    fields = ['description']
    template_name = "courses/task_standard_form.html"
...
class TaskStandardDeleteView(LoginRequiredMixin, DeleteView):
    model = TaskStandard
